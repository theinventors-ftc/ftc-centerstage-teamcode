package org.firstinspires.ftc.teamcode.CenterStageRobot.pipelines;
...
public class Pipeline extends OpenCvPipeline {
    ...
    public Pipeline(Telemetry telemetry, Alliance allianceType, double threshhold,
                    double blurAmount) {
    ...
    public Mat processFrame(Mat input) {
        ...
        telemetry.addData("Position: ", getDetection());
